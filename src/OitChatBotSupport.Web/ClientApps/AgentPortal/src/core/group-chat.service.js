...
var GroupChatService = (function () {
    function GroupChatService(http, agentHubGateway) {
        this.http = http;
        this.agentHubGateway = agentHubGateway;
    }
    GroupChatService.prototype.getMessages$ = function (group) {
        return this.http.get(environment.baseWebUrl +
            environment.groupMessages +
            '/' + group);
    };
    GroupChatService.prototype.sendGroupMessage = function (agentMessage) {
