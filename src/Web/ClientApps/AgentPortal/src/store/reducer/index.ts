import { ActionReducer, ActionReducerMap, compose, combineReducers, createSelector, MetaReducer } from '@ngrx/store';
...
export const getLoggedAgents = createSelector(get)
